...
def _to_sequence_example(image, decoder, vocab):
  ...
  feature_lists = tf.train.FeatureLists(feature_list={
      "image/caption": _bytes_feature_list([w.encode('utf-8') for w in caption]),
...
def main(unused_argv):
  ...
  train_cutoff = int(0.90 * len(mscoco_train_dataset))
  val_cutoff = int(0.95 * len(mscoco_train_dataset))
  train_dataset = mscoco_train_dataset[:train_cutoff]  #+ mscoco_val_dataset[0:train_cutoff]
