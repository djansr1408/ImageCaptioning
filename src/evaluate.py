...
tf.flags.DEFINE_string("input_file_pattern", os.path.join(utils.repo_path, 'output_data\\test-?????-of-00008'),
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("checkpoint_dir", os.path.join(utils.repo_path, 'src\\train_log'),
                       "Directory containing model checkpoints.")
tf.flags.DEFINE_string("eval_dir", os.path.join(utils.repo_path, 'eval_dir'), "Directory to write event logs.")

tf.flags.DEFINE_integer("eval_interval_secs", 30,
