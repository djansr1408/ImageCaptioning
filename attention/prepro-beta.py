...
def _process_caption_data(caption_file, image_dir, max_length, max_count):
...
def main():
    ...
    image_dir = r'C:\Users\PSIML-1.PSIML-1\Desktop\projekti\Image-Captioning\attention\image\%2014_resized/'
